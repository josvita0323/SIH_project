...
export function ProcurementOfficerDashboard({ onBack }: { onBack: () => void }) {
  const invoices = mockDocuments.filter((d) => d.type === "vendor-invoice")
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <header className="bg-white border-b sticky top-0 z-40">
        <div className="px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold">KMRL Procurement</h1>
      ...
      <section className="p-6">
        ...
        <InboxList role="procurement-officer" />
      </section>
    </main>
  )
}
