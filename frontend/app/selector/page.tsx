      ...
      <section className="container mx-auto px-4 py-8">
        <div className="text-center max-w-3xl mx-auto mt-10 mb-8">
          <h2 className="text-3xl font-bold text-balance">
            Who's using the demo?
          </h2>
          <p className="text-muted-foreground mt-2">
            Choose a role to preview tailored information, actions, and
            workflows.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card
            ...
            onClick={() => handleSelect("rolling-stock-manager")}
          >
            <CardHeader className="space-y-2">
              ...
              <CardDescription>
                Oversees train availability, rolling-stock readiness, and
          ...
          <Card
            className="hover:shadow-lg transition cursor-pointer"
            onClick={() => handleSelect("procurement-officer")}
          >
            <CardHeader className="space-y-2">
              <div className="flex items-center gap-3">
              ...
              <CardDescription>
                Manages vendor contracts, spare-parts purchasing, and invoice
                approvals.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card
            className="hover:shadow-lg transition cursor-pointer"
            onClick={() => handleSelect("hr-safety-coordinator")}
          >
            <CardHeader className="space-y-2">
              <div className="flex items-center gap-3">
              ...
              <CardDescription>
                Organizes training, circulates safety circulars, and tracks
                compliance.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card
            className="hover:shadow-lg transition cursor-pointer"
            onClick={() => handleSelect("executive-director")}
          >
            <CardHeader className="space-y-2">
              <div className="flex items-center gap-3">
              ...
              <CardDescription>
                Oversees strategy, compliance, and board reporting with
                high-level insights.
              </CardDescription>
            </CardHeader>
          </Card>
