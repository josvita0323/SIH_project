...
class OCR_Manager:
    ...
    def __process_page(self, image_vector, page_number: int) -> list[dict] | None:
        try:
            data = {
                "content":[],
